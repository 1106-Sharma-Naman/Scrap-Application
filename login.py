...
# Optional: Scaling for Retina displays
try:
...
entry_config = {
    ...
    "bg": "white",
    "fg": "black",
    "insertbackground": "black"  # for macOS cursor visibility
}

# Username
tk.Label(container, text="Username", font=label_font, bg="#f0f0f0", fg="black").pack(pady=(10, 0))
username_entry = tk.Entry(container, **entry_config)
username_entry.pack(ipady=8, pady=5)

# Company ID
tk.Label(container, text="Company ID", font=label_font, bg="#f0f0f0", fg="black").pack(pady=(10, 0))
company_id_entry = tk.Entry(container, **entry_config)
company_id_entry.pack(ipady=8, pady=5)

# Password
tk.Label(container, text="Password", font=label_font, bg="#f0f0f0", fg="black").pack(pady=(10, 0))
